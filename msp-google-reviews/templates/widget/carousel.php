...
>
	...
	<div class="msp-cta-buttons">
		...
		<a href="<?php echo $read_more_url; // Already esc_url()'d by PresenterService ?>"
		...
		<a href="<?php echo $write_review_url; // Already esc_url()'d by PresenterService ?>"
